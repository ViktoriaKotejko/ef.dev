...
function options_typography_enqueue_google_font($font) {
    ...
    wp_enqueue_style( "options_typography_$font", "http://fonts.googleapis.com/css?family=$font&subset=cyrillic-ext,cyrillic,latin,latin-ext", false, null, 'all' );
}
     ...
     $input = '';
		 ...
		 if ( of_get_option( 'google_mixed_3' ) ) {
          $input = of_get_option( 'google_mixed_3' );
					...
					$output .= options_typography_font_styles_body( of_get_option( 'google_mixed_3' ) , '#desc');
					$output .= options_typography_font_styles_body( of_get_option( 'google_mixed_3' ) , '#main-content');
